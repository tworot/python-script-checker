...
def fetch_data(directory):
    ...
    for file in files:
        ...
        test_results = tuple(map(sum, zip(*test_results_list)))
        print(test_results)
        data.append([file,
                     str(test_results[0]),
                     str(test_results[1]) + "/" + number_of_tests,
                     str(test_results[2]) + "/" + number_of_tests,
                     str(test_results[3]) + "/" + number_of_tests,
                     str(test_results[1]/int(number_of_tests)*100) + "%"
                     ])
